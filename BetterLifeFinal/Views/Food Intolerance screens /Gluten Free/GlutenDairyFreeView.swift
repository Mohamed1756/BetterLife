...
class GlutenDairyFreeView:UIViewController,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    func GlutenDairyBreakfastPlist () -> [[String:String]] {
        
        let path = Bundle.main.path(forResource: "GlutenDairyBreakfast", ofType: "plist")
        
        return NSArray.init(contentsOf: URL.init (fileURLWithPath: path!)) as! [[String:String]]
        
        
    }
    func GlutenDairyLunchPlist() -> [[String:String]] {
        
        let path1 = Bundle.main.path (forResource: "GlutenDairyLunch", ofType: "plist")
        
        return NSArray.init(contentsOf: URL.init (fileURLWithPath: path1!)) as! [[String:String]]
        
    }
    func GlutenDairyDinnerPlist() -> [[String:String]] {
        
        let path2 = Bundle.main.path (forResource: "GlutenDairyDinner", ofType: "plist")
    ...
    override func viewDidLoad() {
        ...
        self.breakfastItems = GlutenDairyBreakfastPlist()
        // load Lunch Images
        self.lunchItems = GlutenDairyLunchPlist()
        // load dinner images
        self.dinnerItems = GlutenDairyDinnerPlist()
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        
        if segue.identifier == "glutenDairyBreakfastToRecipe" {
        ...
        if segue.identifier == "glutenDairyLunchToRecipe" {
        ...
        if segue.identifier == "glutenDairyDinnerToRecipe" {
