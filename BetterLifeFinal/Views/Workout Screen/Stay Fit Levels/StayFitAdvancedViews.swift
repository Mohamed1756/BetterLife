...
class StayFitAdvancedViews: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func StayFitAdvancedWeekOnePlist () -> [[String:String]] {
        
        let path = Bundle.main.path(forResource: "stayFitAdvancedWeekOne", ofType: "plist")
        
        return NSArray.init(contentsOf: URL.init (fileURLWithPath: path!)) as! [[String:String]]
        
    }
    func StayFitAdvancedWeekTwoPlist () -> [[String:String]] {
        
        let path1 = Bundle.main.path(forResource: "stayFitAdvancedWeekTwo", ofType: "plist")
        
        return NSArray.init(contentsOf: URL.init (fileURLWithPath: path1!)) as! [[String:String]]
        
    }
    func StayFitAdvancedWeekThreePlist () -> [[String:String]] {
        
        let path2 = Bundle.main.path(forResource: "stayFitAdvancedWeekThree", ofType: "plist")
    ...
    override func viewDidLoad() {
        // load  images
        self.firstWeekItems = StayFitAdvancedWeekOnePlist()
        
        self.secondWeekItems = StayFitAdvancedWeekTwoPlist()
        
        self.thirdWeekItems = StayFitAdvancedWeekThreePlist()
     
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        
        if segue.identifier == "stayFitAdvancedWeekOneToWorkout" {
        ...
        if segue.identifier == "stayFitAdvancedWeekTwoToWorkout" {
        ...
        if segue.identifier == "stayFitAdvancedWeekThreeToWorkout" {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if (collectionView == firstWeekCollectionView) {
            ...
            WeekOneCell.stayFitAdvancedWeekOneTextLabel.text = firstWeekLabels[indexPath.row]
            WeekOneCell.stayFitAdvancedWeekOneImage.image = UIImage(named:firstWeekItem ["Image"]!)
        ...
        if (collectionView == secondWeekCollectionView) {
            ...
            WeekTwoCell.stayFitAdvancedWeekTwoTextLabel.text = secondWeekLabels[indexPath.row]
            WeekTwoCell.stayFitAdvancedWeekTwoImage.image = UIImage(named: secondWeekItem ["Image"]!)
        ...
        WeekThreeCell.stayFitAdvancedWeekThreeTextLabel.text = thirdWeekLabels[indexPath.row]
        WeekThreeCell.stayFitAdvancedWeekThreeImage.image = UIImage(named: thirdWeekItem ["Image"]!)
