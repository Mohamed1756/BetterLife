//
//  StayFitIntermediateViews.swift
//  BetterLifeFinal
//
...
class StayFitIntermediateViews: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func StayFitIntermediateWeekOnePlist () -> [[String:String]] {
        
        let path = Bundle.main.path(forResource: "stayFitIntermediateWeekOne", ofType: "plist")
        
        return NSArray.init(contentsOf: URL.init (fileURLWithPath: path!)) as! [[String:String]]
        
    }
    func StayFitIntermediateWeekTwoPlist () -> [[String:String]] {
        
        let path1 = Bundle.main.path(forResource: "stayFitIntermediateWeekTwo", ofType: "plist")
        
        return NSArray.init(contentsOf: URL.init (fileURLWithPath: path1!)) as! [[String:String]]
        
    }
    func StayFitIntermediateWeekThreePlist () -> [[String:String]] {
        
        let path2 = Bundle.main.path(forResource: "stayFitIntermediateWeekThree", ofType: "plist")
    ...
    override func viewDidLoad() {
        // load  images
        self.firstWeekItems = StayFitIntermediateWeekOnePlist()
        
        self.secondWeekItems = StayFitIntermediateWeekTwoPlist()
        
        self.thirdWeekItems = StayFitIntermediateWeekThreePlist()
     
    }
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        
        if segue.identifier == "stayFitIntermediateWeekOneToWorkout" {
        ...
        if segue.identifier == "stayFitIntermediateWeekTwoToWorkout" {
        ...
        if segue.identifier == "stayFitIntermediateWeekThreeToWorkout" {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if (collectionView == firstWeekCollectionView) {
            ...
            WeekOneCell.stayFitIntermediateWeekOneTextLabel.text = firstWeekLabels[indexPath.row]
            WeekOneCell.stayFitIntermediateWeekOneImage.image = UIImage(named:firstWeekItem ["Image"]!)
        ...
        if (collectionView == secondWeekCollectionView) {
            ...
            WeekTwoCell.stayFitIntermediateWeekTwoTextLabel.text = secondWeekLabels[indexPath.row]
            WeekTwoCell.stayFitIntermediateWeekTwoImage.image = UIImage(named: secondWeekItem ["Image"]!)
        ...
        WeekThreeCell.stayFitIntermediateWeekThreeTextLabel.text = thirdWeekLabels[indexPath.row]
        WeekThreeCell.stayFitIntermediateWeekThreeImage.image = UIImage(named: thirdWeekItem ["Image"]!)
